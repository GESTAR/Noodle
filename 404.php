	...
	<div id="primary">
		<div id="postlist">
			<div id="post-<?php the_ID(); ?>" <?php post_class();?>>
				<script language="javascript" type="text/javascript">var i=5,intervalid,Url="http://tomner.com";intervalid=setInterval("fun()",1000);function fun(){if(i==0){window.location.href = Url;clearInterval(intervalid)}document.getElementById("mes").innerHTML=i;i--}</script>  
